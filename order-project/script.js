function startOrder() {
  ...
  document.getElementById("o-name").textContent = customer_name;
  document.getElementById("o-flover").textContent = selectedFlavor;
  document.getElementById("o-size").textContent = sizeInput;
  document.getElementById("o-cups").textContent = cupCount;
  document.getElementById("o-suger").textContent = sugerText;
  document.getElementById("o-total").textContent = total;
  document.getElementById("reciept").classList.add("show");
